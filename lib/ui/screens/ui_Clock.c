...
void ui_Clock_screen_init(void)
{
    ...
    lv_obj_set_style_bg_image_src(ui_Clock, &ui_img_pattern_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_remove_flag(ui_Clock_Panel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_Min = lv_image_create(ui_Clock_Panel);
    lv_image_set_src(ui_Min, &ui_img_clock_min_png);
    ...
    ui_Hour = lv_image_create(ui_Clock_Panel);
    lv_image_set_src(ui_Hour, &ui_img_clock_hour_png);
    ...
    ui_Sec = lv_image_create(ui_Clock_Panel);
    lv_image_set_src(ui_Sec, &ui_img_clock_sec_png);
    ...
    lv_image_set_rotation(ui_Sec, 150);
    ...
    lv_obj_remove_flag(ui_Clock_Center, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
